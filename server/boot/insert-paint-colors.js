...
module.exports = function (app) {
  ...
  function insertMasterData() {
    PaintColor.create([
      ...
      {
        name: 'Brass Scorpion(Metal)',
        range: 'Layer',
        hexColor: 'B7885F'
      },
      {
        name: 'Cadian Fleshstone',
        range: 'Layer',
        hexColor: 'C77958'
      },
      {
      ...
      {
        name: 'Fulgurite Coper (Metal)',
        range: 'Layer',
        hexColor: 'E6B77E'
      },
      {
        name: 'Gehenna\'s Gold (Metal)',
        range: 'Layer',
        hexColor: 'DBA674'
      },
      {
      ...
      {
        name: 'Runefang Steel (Metal)',
        range: 'Layer',
        hexColor: 'C3CACE'
      },
      {
        name: 'Runelord Brass(Metal)',
        range: 'Layer',
        hexColor: 'B6A89A'
      },
      {
      ...
      {
        name: 'Agrax Earthshade (Devlan Mud)',
        range: 'Shade',
        hexColor: '5A573F'
      },
      {
